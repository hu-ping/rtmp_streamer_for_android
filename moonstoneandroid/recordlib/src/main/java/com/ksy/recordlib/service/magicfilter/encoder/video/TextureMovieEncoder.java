...
package com.ksy.recordlib.service.magicfilter.encoder.video;
...
import com.ksy.recordlib.service.magicfilter.filter.helper.MagicFilterFactory;
...
//        for(int i = 0; i < gLTextureBuffer.capacity(); i++) {
//            gLTextureBuffer.put(0.0f);
//        }
