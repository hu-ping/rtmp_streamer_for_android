package com.ksy.recordlib.service.magicfilter.widget;
...
//    private boolean recordingEnabled;
    ...
    private static final int RECORDING_UNKNOWN = -1;
    private static final int RECORDING_OFF = 0;
    private static final int RECORDING_ON = 1;
    private static final int RECORDING_RUNNING = 2;
    private static final int RECORDING_RESUMED = 3;
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        switch (recordingStatus) {
            case RECORDING_ON:
                ...
                textureVideoEncoder.setCubeBuffer(gLCubeBuffer);
                textureVideoEncoder.initialize();
                textureVideoEncoder.start();

                recordingStatus = RECORDING_RUNNING;
            case RECORDING_RUNNING:
//                textureVideoEncoder.setTextureId(id);
                textureVideoEncoder.frameAvailable(id, surfaceTexture);
                break;

            case RECORDING_RESUMED:
                textureVideoEncoder.updateSharedContext(EGL14.eglGetCurrentContext());
                recordingStatus = RECORDING_RUNNING;
                break;
