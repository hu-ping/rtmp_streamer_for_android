 ...
 */
public class SMRecordClientConfig {
    ...
    int mVideoProfile;
    int cameraOriention;
    int recordOrientation;

    static int previewOrientation;
    ...
    public SMRecordClientConfig(Builder builder) {
...
//            int previewDegree = CameraUtil.getDisplayOrientation(orientationActivity,
...
//        }
    ...
    public SMRecordClientConfig setRecordOrientation(int recordOrientation) {
        this.recordOrientation = recordOrientation;
        return this;
    }

    public SMRecordClientConfig setmCameraType(int mCameraType) {
        this.mCameraType = mCameraType;
        return this;
    }

    public SMRecordClientConfig setmVoiceType(int mVoiceType) {
        this.mVoiceType = mVoiceType;
        return this;
    }

    public SMRecordClientConfig setmAudioSampleRate(int mAudioSampleRate) {
        this.mAudioSampleRate = mAudioSampleRate;
        return this;
    }

    public SMRecordClientConfig setmAudioBitRate(int mAudioBitRate) {
        this.mAudioBitRate = mAudioBitRate;
        return this;
    }

    public SMRecordClientConfig setmAudioEncoder(int mAudioEncoder) {
        this.mAudioEncoder = mAudioEncoder;
        return this;
    }

    public SMRecordClientConfig setmVideoFrameRate(int mVideoFrameRate) {
        this.mVideoFrameRate = mVideoFrameRate;
        return this;
    }

    public SMRecordClientConfig setmVideoBitRate(int mVideoBitRate) {
        this.mVideoBitRate = mVideoBitRate;
        return this;
    }

    public SMRecordClientConfig setmDropFrameFrequency(int mDropFrameFrequency) {
        this.mDropFrameFrequency = mDropFrameFrequency;
        return this;
    }

    public SMRecordClientConfig setmVideoWidth(int mVideoWidth) {
        this.mVideoWidth = mVideoWidth;
        return this;
    }

    public SMRecordClientConfig setmVideoHeight(int mVideoHeight) {
        this.mVideoHeight = mVideoHeight;
        return this;
    }

    public SMRecordClientConfig setmVideoEncoder(int mVideoEncoder) {
        this.mVideoEncoder = mVideoEncoder;
        return this;
    }

    public SMRecordClientConfig setmVideoProfile(int mVideoProfile) {
        this.mVideoProfile = mVideoProfile;
        return this;
    }

    public SMRecordClientConfig setmUrl(String mUrl) {
        this.mUrl = mUrl;
        return this;
    }
    ...
    public SMRecordClientConfig setOrientationActivity(OrientationActivity orientationActivity) {
...
//        private int mCameraType = Constants.CONFIG_CAMERA_TYPE_FRONT;
        ...
        public SMRecordClientConfig build() {
            return new SMRecordClientConfig(this);
        }
